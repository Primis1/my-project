...
const contactMethods = [
  {
    icon: Phone,
    title: "Call Us",
    description: "Speak with a life & income advisor",
    action: "(555) 123-4567",
  ...
  },
  {
    ...
    action: "life@integrated.com",
    available: "Response within 24h",
  },
  {
    icon: Calendar,
    title: "Schedule",
    description: "Book a needs analysis",
    action: "Pick a Time",
    available: "45 min confidential call",
  },
]

const benefits = [
  "Independent — we work for you, not a carrier",
  "Life-event triggered reviews included",
  "Income replacement & life insurance expertise",
  "Personal & group health plan options",
]
...
export function CTASection() {
  ...
  return (
    <section id="life-contact" className="py-20 lg:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-4">
            Connect With Our Life & Income Team
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Choose how you&apos;d like to connect. Our licensed advisors are ready to
            help you protect your income, your family, and your future.
          </p>
        </div>

        <ul aria-label="Life & income advisor contact methods" className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-white">
              ...
              <p className="text-primary-foreground/80 mb-6 leading-relaxed">
                ...
                confidential needs analysis. No obligation — just clarity on what
                protection looks like for you.
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/20">
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label htmlFor="li-cta-email" className="text-sm font-medium text-white mb-2 block">
                    Email Address
                  </label>
                  <Input
                    id="li-cta-email"
                ...
                <p className="text-xs text-white/60 text-center">
                  By submitting, you agree to our Terms. Your information is kept strictly confidential.
                </p>
              </form>
            </div>
          </div>
        ...
        >
          <div className="flex flex-col items-center md:items-start">
            <span itemProp="name" className="font-bold text-foreground mb-1">Integrated Insurance Agency — Life & Income Division</span>
